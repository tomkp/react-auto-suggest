...
describe("AutoSuggest", function () {
    ...
    var onSuggestion = function onSuggestion(suggestion) {
        console.info("onSuggestion", suggestion);
    };

    var autoSuggest = TU.renderIntoDocument(React.createElement(AutoSuggest, { suggestions: fetchSuggestions, onSuggestion: onSuggestion }));
    ...
    it("should pass entered text to suggestions function", function () {
        ...
        var autoSuggest = TU.renderIntoDocument(React.createElement(AutoSuggest, { suggestions: callback, onSuggestion: onSuggestion }));
        var searchBox = TU.findRenderedDOMComponentWithClass(autoSuggest, "SearchBox");
        TU.Simulate.change(searchBox.getDOMNode(), { target: { value: "cat" } });
        expect(searchBox.getDOMNode().value).toEqual("cat");
